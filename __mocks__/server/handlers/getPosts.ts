...
export const getPostsEndPoints = {
  getPosts: '*/api/posts',
};
...
export interface GetPostParams extends PathParams {}

export const getPostsHandler = http.get<GetPostParams>(
  getPostsEndPoints.getPosts,
  (req) => {
