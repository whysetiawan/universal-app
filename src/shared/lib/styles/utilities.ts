...
export const utilities = StyleSheet.create({
  ...
  border: {
    borderWidth: StyleSheet.hairlineWidth as 1,
  },
  border_t: {
    borderTopWidth: StyleSheet.hairlineWidth as 1,
  },
  border_b: {
    borderBottomWidth: StyleSheet.hairlineWidth as 1,
  },
  border_l: {
    borderLeftWidth: StyleSheet.hairlineWidth as 1,
  },
  border_r: {
    borderRightWidth: StyleSheet.hairlineWidth as 1,
  },
  ...
  rounded_2xl: {
    borderRadius: tokens.borderRadius._2xl,
  },
  rounded_3xl: {
    borderRadius: tokens.borderRadius._3xl,
  },
  rounded_4xl: {
    borderRadius: tokens.borderRadius._4xl,
  },
  rounded_full: {
